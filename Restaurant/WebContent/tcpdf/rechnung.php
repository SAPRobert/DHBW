...
include_once'../php/warenkorb.php';
include_once'../php/addBestellung.php';
...
$rechnungs_footer = "Der Betrag wurde vollständig beglichen. Danke für Ihren Besuch!";

// <b>Empfänger:</b> Robert Schwarz
...
// 	array("Produkt 3", 3, 10.00));
    ...
    for ($i = 0; $i < count($Array); $i ++) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $zeile = $zeile + 1;
            $druck[$i]=[$row['prod_name'], $innerArray[1], $row['prod_preis'] ];
//             echo "<tr>" .
//                 // "<th>" . $row['prod_id'] ."</th>".
